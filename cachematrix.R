#The following functions allow the calculation of the inverse of a given matrix
#and cache the result. When invoking the solver function the cache is checked and
#the cache value used if it exists, otherwise it is calculated and cached.



#The first function, makeCacheMatrix creates a special "matrix", which is really
#a list containing of functions doing the following
